...
if [[ -f "$HOME/GitHub/davidjamesfriedman/dotfiles/scripts/shell/git/functions.sh" ]]; then
  source "$HOME/GitHub/davidjamesfriedman/dotfiles/scripts/shell/git/functions.sh"
fi
