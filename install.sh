...
function installDotfiles() {
  ...
  mkdir -p ~/.local/bin
  mkdir -p ~/GitHub/davidjamesfriedman/dotfiles/scripts
  ...
  echo "    - Shell modules to ~/GitHub/davidjamesfriedman/dotfiles/scripts"
  if [ -d "scripts" ]; then
    # Ensure the destination exists
    mkdir -p ~/GitHub/davidjamesfriedman/dotfiles
    # Copy the entire scripts directory structure
    cp -R scripts ~/GitHub/davidjamesfriedman/dotfiles/
  ...
  echo "  - Modular functions installed to ~/GitHub/davidjamesfriedman/dotfiles/scripts/shell/"
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
  ...
  cargo install --git https://github.com/davidjamesfriedman/quill
  go install github.com/davidjamesfriedman/bluetooth-tui@latest
  go install github.com/davidjamesfriedman/azure-searcher@latest
